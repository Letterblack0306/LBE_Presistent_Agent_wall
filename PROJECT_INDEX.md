...
| `C:\LBE-TUI-Lab\cline\apps\cli`, `C:\LBE-TUI-Lab\run-cline-lbe.ps1` | **Accepted user-facing Cline CLI/TUI client and integrated launcher**; client/projection only, with installed acceptance not implied | Cline CLI client over LBE runtime authority | `docs/CURRENT_STATUS.md` and `docs/IMPLEMENTATION_PLAN.md` | Cline may own reasoning mechanics and presentation; LBE owns identity, policy, authorization, execution, receipts, evidence, persistence, validation, and completion |
